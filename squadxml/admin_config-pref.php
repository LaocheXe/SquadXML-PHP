...
class squadxml_exesystem_ui extends e_admin_ui
{
	...
	//	protected $listQry      	= "SELECT * FROM `#tableName` WHERE field != '' "; // Example Custom Query. LEFT JOINS allowed. Should be without any Order or Limit.
		...
		protected $fields 		= array (  'checkboxes' =>   array ( 'title' => '', 'type' => null, 'data' => null, 'width' => '5%', 'thclass' => 'center', 'forced' => '1', 'class' => 'center', 'toggle' => 'e-multiselect',  ),
		  ...
		  'arma_id' =>   array ( 'title' => LAN_ID, 'type' => 'text', 'data' => 'str', 'width' => '5%', 'inline' => true, 'help' => '', 'readParms' => '', 'writeParms' => '', 'class' => 'left', 'thclass' => 'left',  ),
		  'arma_remark' =>   array ( 'title' => 'Remark', 'type' => 'textarea', 'data' => 'str', 'width' => 'auto', 'inline' => true, 'help' => '', 'readParms' => '', 'writeParms' => '', 'class' => 'left', 'thclass' => 'left',  ),
		  'arma_icq' =>   array ( 'title' => 'Icq', 'type' => 'text', 'data' => 'str', 'width' => 'auto', 'inline' => true, 'help' => '', 'readParms' => '', 'writeParms' => '', 'class' => 'left', 'thclass' => 'left',  ),
		  'options' =>   array ( 'title' => LAN_OPTIONS, 'type' => null, 'data' => null, 'width' => '10%', 'thclass' => 'center last', 'class' => 'center last', 'forced' => '1',  ),
		);		
		
		protected $fieldpref = array('user_id', 'arma_id', 'arma_remark', 'arma_icq');
		

	//	protected $preftabs        = array('General', 'Other' );
		protected $prefs = array(
			'Unit Name'		=> array('title'=> 'Unit Name', 'tab'=>0, 'type'=>'text', 'data' => 'str', 'help'=>''),
			'Unit Tags'		=> array('title'=> 'Unit Tags', 'tab'=>0, 'type'=>'text', 'data' => 'str', 'help'=>''),
			'Unit Email'		=> array('title'=> 'Unit Email', 'tab'=>0, 'type'=>'text', 'data' => 'str', 'help'=>''),
			'Unit Website'		=> array('title'=> 'Unit Website', 'tab'=>0, 'type'=>'url', 'data' => 'str', 'help'=>''),
			'Unit JPG/PAA'		=> array('title'=> 'Unit JPG/PAA', 'tab'=>0, 'type'=>'text', 'data' => 'str', 'help'=>''),
			'Unit Title'		=> array('title'=> 'Unit Title', 'tab'=>0, 'type'=>'text', 'data' => 'str', 'help'=>''),
		); 
